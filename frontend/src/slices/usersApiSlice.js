...
export const userApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    authUserWithClerk: builder.mutation({
      query: (data) => ({
        url: `${USERS_URL}/clerk/auth`,
        method: 'POST',
        body: data,
      }),
    }),
    verifyClerkSession: builder.mutation({
      query: (data) => ({
        url: `${USERS_URL}/clerk/verify`,
        method: 'POST',
        body: data,
      }),
    }),
...
export const {
  ...
  useAuthUserWithClerkMutation,
  useVerifyClerkSessionMutation,
} = userApiSlice;
