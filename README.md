...
- Integration with Clerk for secure social login via LinkedIn.
- Streamlined authentication flow with modern security practices.
- JWT token-based session management with secure HTTP-only cookies.
- Role-based access control integrated with Clerk authentication.
